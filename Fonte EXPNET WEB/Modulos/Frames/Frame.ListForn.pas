...
type
  TFrameListForn = class(TUniFrame)
    ...
    procedure qryListFornstatusGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
    procedure qryListFornacaoGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
...
uses  ServerModule, MainModule, Main;


procedure TFrameListForn.Action1Execute(Sender: TObject);
begin
ShowMessage('teste');
end;

procedure TFrameListForn.ControlAction1Execute(Sender: TObject);
begin
ShowMessage('teste');
end;

procedure TFrameListForn.qryListFornacaoGetText(Sender: TField; var Text: string;
  DisplayText: Boolean);
begin
 {
     if DisplayText then
...
procedure TFrameListForn.qryListFornstatusGetText(Sender: TField; var Text: string;
  DisplayText: Boolean);
