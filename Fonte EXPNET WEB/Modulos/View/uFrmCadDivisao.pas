...
UniFSToast,
  ...
  Data.DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, UniFSConfirm;
...
begin
FDTable1.Delete;
dmToast.Toast.Warning('Este registro foi excluído com sucesso!','',TToastPosition.bottomRight);
end;
...
begin
dmToast.Toast.Success('Este registro foi salvo com sucesso!','',TToastPosition.bottomRight);
FDTable1.Post;
