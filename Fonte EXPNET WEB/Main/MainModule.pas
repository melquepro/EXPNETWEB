...
uses
  ...
  FireDAC.Phys.MySQLDef, FireDAC.VCLUI.Error, FireDAC.VCLUI.Wait,
  FireDAC.Stan.Param, FireDAC.DatS, FireDAC.DApt.Intf, FireDAC.DApt, Data.DB,
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, FireDAC.Moni.Base,
  FireDAC.Moni.Custom, FireDAC.Comp.UI;

type
  TuniDM = class(TUniGUIMainModule)
...
function uniDM: TuniDM;
begin
  Result := TuniDM(UniApplication.UniMainModule)
end;

initialization
  RegisterMainModuleClass(TuniDM);
end.
